...
<!---->
	...
	<form method="post">
		...
		<c:forEach items="${cartList }" var="cart">
			...
			<tbody>
				<tr>
					<td class="goods"><img src="images/${cart.type.photo }" alt="" /><span>${cart.goods.name }/
							${cart.type.kind }</span></td>
					<td class="price">${cart.goods.preprice }<del>${cart.goods.oriprice }</del></td>
					<td class="count"> ${cart.cartsum }</td>
					<td class="subtotal">${cart.goods.preprice *cart.cartsum}</td>
					<td class="operation"><span class="delete">删除</span></td>
				</tr>
				<tr>
					<td><h5>商品号:</h5></td>
					<td colspan="4">${cart.goods.gid }</td>
				</tr>
				<tr>
					<td><h5>货号:</h5></td>
					<td colspan="4">${cart.ctid }</td>
				</tr>
				<tr>
					<td><h5>商家姓名&联系电话:</h5></td>
					<td colspan="4">${cart.goods.user.truename }&${cart.goods.user.phone }</td>
				</tr>
				<tr>
					<td><h5>家具名：</h5></td>
					<td colspan="4">${cart.goods.name }</td>
				</tr>
				<tr>
					<td><h5>家具简介：</h5></td>
					<td colspan="4">${cart.goods.info }</td>
				</tr>
				<tr>
					<td><h5>家具属性：</h5></td>
					<td colspan="4">${cart.type.kind }</td>
				</tr>
				<tr>
					<td>备注 :</td>
				...
				<tr>
					<td><h5>家具单价*件数：</h5></td>
					<td colspan="4">${cart.goods.preprice }* ${cart.cartsum }</td>
				</tr>
				</c:forEach>
				<tr>
					<td><h5>选择收货地址：</h5>
				...
				<tr>
					...
					<input type="submit" onclick="javascript:this.form.action='getcart?uid=${user.uid }'" value="取消订单" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="submit" onclick="javascript:this.form.action='addmoreorder?uid=${user.uid }&typeid=${typeid }'" value="提交订单" />
					</td>
				</tr>
			</tbody>
		</table>
