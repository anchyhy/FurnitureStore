...
<div class="login_sec">
	 <div class="container">
		 ...
		 <div class="col-md-6 log">			 
				 <form action="login">
					 <h5>登录名:</h5>	
					 <input placeholder="昵称/手机号/邮箱"type="text" value="" name="loginname">
					 <h5>密码:</h5>
					 <input placeholder="密码" type="password" value="" name="password">					
					 <input type="submit" value="登录">
					  <a href="logintoforgetpass">忘记密码 ?</a>
				 </form>				 
		 </div>
		  <div class="col-md-6 login-right">
			  	<h3>注册</h3>
				<p>通过在商城注册一个账户, 会使您的购物更加便捷, 您可以管理您的地址, 将喜爱的家居商品添加至收藏，追踪您的订单.</p>
				<a class="acount-btn" href="logintoaccount">创建一个新的账号</a>
		 </div>
		 <div class="clearfix"></div>
	 </div>
</div>
