		...
		<table id="cartTable">
			...
			<tbody>
				<c:forEach items="${addressList }" var="address">
					<tr>
						<td>${address.aid }.</td>
						<td colspan="3">${address.province }/${address.city }/${address.district }/${address.detail }</td>
						<td><input type="submit" value="删除"
							onclick="javascript:this.form.action='deladdress?aid=${address.aid }&auid=${user.uid }'"></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
			...
			<div class="registration_left">
				...
				<div class="registration_form">
					...
					<form id="registration_form" action="" method="post">
						<div>
							<label> <input name="province" placeholder="省"
								type="text" tabindex="1" required autofocus>
							</label>
						</div>
						<div>
							<label> <input name="city" placeholder="市" type="text"
								tabindex="1" required autofocus>
							</label>
						</div>
						<div>
							<label> <input name="district" placeholder="区"
								type="text" tabindex="3" required>
							</label>
						</div>
						<div>
							<label> <input name="detail" placeholder="详细地址"
								type="text" tabindex="3" required>
							</label>
						</div>
						<div>
							<input type="submit"
								onclick="javascript:this.form.action='addaddress?auid=${user.uid}'"
								value="添加" id="register-submit">
						</div>
