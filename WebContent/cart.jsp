...
<div class="catbox">
<form  method="post" action="carttoorder?uid=${user.uid }">
  <table id="cartTable">
    <thead>
      <tr>
        <th><label>
    ...
    <c:forEach items="${cartList }" var="cart">
      <tr>
        <td class="checkbox"><input class="check-one check" type="checkbox" value="${cart.type.tid }" name="typeid"/></td>
        <td class="goods"><img src="images/${cart.type.photo }" alt=""/><span>${cart.goods.gid }.${cart.goods.name }/ ${cart.type.kind }</span></td>
        <td class="price">${cart.goods.preprice }</td>
        <td class="count"><span class="reduce" onclick="location.href='reducequantity?uid=${user.uid }&ctid=${cart.type.tid }'">-</span>
          <input class="count-input" type="text" value="${cart.cartsum }" name="quantity" disabled="disabled"/>
          <span class="add" onclick="location.href='addquantity?uid=${user.uid }&ctid=${cart.type.tid }'">+</span></td>
        <td class="subtotal">${cart.goods.preprice *cart.cartsum }</td>
        <td class="operation"><span class="delete" onclick="location.href='delcart?cid=${cart.cid}'">删除</span></td>
      </tr>
     </c:forEach> 
    </tbody>
  </table>
  <div class="foot" id="foot">
    ...
    <input type="submit" class="fr closing" onclick="location.href='carttoorder?uid=${user.uid }'">结算
