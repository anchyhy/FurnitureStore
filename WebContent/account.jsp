...
<div class="container">
	 ...
	 <div class="registration">
		 <div class="registration_left">
			 ...
			 <!-- Form -->
				<form id="registration_form" action="regist?action=register" method="post">
					<div>
						<label>
							<input name="truename" placeholder="真实姓名:" type="text" tabindex="1" required autofocus>
						</label>
					</div>
					<div>
						<label>
							<input name="nickname" placeholder="昵称:" type="text" tabindex="2" required autofocus>
						</label>
					</div>
					<div>
						<label>
					...
					<div>
						<label>
							<input name="phone" placeholder="手机号码:" type="text" tabindex="3" required>
						</label>
					</div>					
						<div class="sky_form1">
							<ul>
					...
					<div>
						<label>
							<input id="pass" name="password" placeholder="密码" type="password" tabindex="4" required>
						</label>
					</div>						
					<div>
						<label>
							<input id="repass" name="repassword" placeholder="再次输入密码" type="password" tabindex="4" required>
						</label>
					</div>	
					<div>
